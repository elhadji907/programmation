...
$factory->define(App\Fcollective::class, function (Faker $faker) {
    return [
        'uuid' => $faker->uuid,
        'code' => $faker->word,
...
$factory->define(App\Fcollective::class, function (Faker\Generator $faker) use ($autoIncremente_code_col) {
