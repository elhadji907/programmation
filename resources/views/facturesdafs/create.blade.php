                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('facturesdafs') }}">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                    {!! Form::label('TVA/IR :') !!}
                                    {!! Form::text('tva_ir', null, ['placeholder' => 'TVA/IR', 'class' => 'form-control']) !!}
                                    <small id="emailHelp" class="form-text text-muted">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                    ...
                                    {!! Form::textarea('observation', null, ['placeholder' => 'observations éventuelles', 'rows' => 1, 'class' => 'form-control']) !!}
                                    <small id="emailHelp" class="form-text text-muted">
