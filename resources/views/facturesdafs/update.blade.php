                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                ...
                                {!! Form::text('designation', $facturesdaf->designation, ['placeholder' => 'Designation', 'class' => 'form-control']) !!}
                                <small id="emailHelp" class="form-text text-muted">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                {!! Form::label('TVA/IR :') !!}
                                {!! Form::text('tva_ir', $facturesdaf->courrier->tva_ir, ['placeholder' => 'TVA/IR', 'class' => 'form-control']) !!}
                                <small id="emailHelp" class="form-text text-muted">
                                    @if ($errors->has('tva_ir'))
                                        @foreach ($errors->get('tva_ir') as $message)
                                            <p class="text-danger">{{ $message }}</p>
                                        @endforeach
                                    @endif
                                </small>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                ...
                                {!! Form::textarea('observation', $facturesdaf->observation, ['placeholder' => 'observations éventuelles', 'rows' => 1, 'class' => 'form-control']) !!}
                                <small id="emailHelp" class="form-text text-muted">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <a class="btn btn-outline-secondary mt-2" title="télécharger le fichier joint" target="_blank" href="{{ asset($facturesdaf->courrier->getFile()) }}">
