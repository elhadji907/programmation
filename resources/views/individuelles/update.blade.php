            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => 'individuelles/' . $individuelles->id, 'method' => 'PATCH', 'files' => true]) !!}
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    <input id="cin" type="text" class="form-control @error('cin') is-invalid @enderror"
                                        name="cin" placeholder="Votre et cin" value="{{ $individuelles->cin ?? old('cin') }}" autocomplete="cin"
                                        autofocus>
                                    @error('cin')
                                ...
                                <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    <input id="prenom" type="text"
                                        ...
                                        placeholder="Votre et prenom" value="{{ $individuelles->demandeur->user->firstname ?? old('prenom') }}" autocomplete="prenom"
                                        autofocus>
                                    @error('prenom')
                                        <span class="invalid-feedback" role="alert">
                                            <div>{{ $message }}</div>
                                ...
                                <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    <input id="nom" type="text" class="form-control @error('nom') is-invalid @enderror"
                                        name="nom" placeholder="Votre et nom" value="{{ $individuelles->demandeur->user->name ?? old('nom') }}" autocomplete="nom"
                                        autofocus>
                                    @error('nom')
                                        <span class="invalid-feedback" role="alert">
                                            <div>{{ $message }}</div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    <input id="date_naiss" {{ $errors->has('date_r') ? 'is-invalid' : '' }} type="date"
                                        ...
                                        placeholder="Votre date de naissance" value="{{ $individuelles->demandeur->user->date_naissance->format('Y-m-d') ?? old('date_naiss') }}"
                                ...
                                <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    <input id="lieu_naissance" type="text"
                                        ...
                                        value="{{ $individuelles->demandeur->user->lieu_naissance ?? old('lieu_naissance') }}" autocomplete="lieu_naissance">
