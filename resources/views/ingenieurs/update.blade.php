...
@section('title', 'ONFP - Modification ingénieur')
@section('content')
    <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header card-header-primary text-center">
                        ...
                        <p class="card-category">{{ "Ingenieur" }}</p>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ action('IngenieursController@update', $id) }}">
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    <input type="text" name="matricule" class="form-control" id="input-matricule"
                                        placeholder="nom complète" value="{{ old('matricule') ?? $ingenieur->matricule }}">
                                ...
                                <div class="form-group col-md-8 col-lg-8 col-xs-12 col-sm-12">
                                    ...
                                    <input type="text" name="name" class="form-control" id="input-name"
                                        placeholder="nom complète" value="{{ old('name') ?? $ingenieur->name }}">
                                    <small id="emailHelp" class="form-text text-muted">
                                        @if ($errors->has('name'))
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                    ...
                                    <input type="text" name="email" class="form-control" id="input-email"
                                        placeholder="nom complète" value="{{ old('email') ?? $ingenieur->email }}">
                                    <small id="emailHelp" class="form-text text-muted">
                                        @if ($errors->has('email'))
                                ...
                                <div class="form-group col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                    ...
                                    <input type="text" name="telephone" class="form-control" id="input-telephone"
                                        placeholder="nom complète" value="{{ old('telephone') ?? $ingenieur->telephone }}">
                                    <small id="emailHelp" class="form-text text-muted">
