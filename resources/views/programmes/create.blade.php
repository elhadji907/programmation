...
@section('title', 'ONFP - Enregistrement programmes')
@section('content')
<div class="content">
                        ...
                        <form method="POST" action="{{ url('programmes') }}">
                           @csrf
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="name" class="form-control" id="input-name" placeholder="Nom du programme" value="{{ old('name') }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="sigle" class="form-control" id="input-name" placeholder="sigle" value="{{ old('sigle') }}">
                                <small id="emailHelp" class="form-text text-muted">
                                        @if ($errors->has('sigle'))
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="effectif" class="form-control" id="input-name" placeholder="effectif" value="{{ old('effectif') }}">
                                <small id="emailHelp" class="form-text text-muted">
