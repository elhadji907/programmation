                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::select('status', ['Attente' => 'Attente', 'Retenue' => 'Retenue', 'Annulée' => 'Annulée', 'Présélectionné' => 'Présélectionné', 'Absent' => 'Absent', 'En cours' => 'En cours', 'Terminée' => 'Terminée'], 
                        ...
                        <div class="form-row">
                         {{--     <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                {!! Form::select('modules[]', $modules, $demandeurs->modules, ['placeholder' => 'choisir','class' =>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                {!! Form::select('niveaux', $niveaux, $demandeurs->nivauxes, ['placeholder' => 'choisir', 'class' =>
                                'form-control', 'id' => 'niveau']) !!}
                            </div>

                            <div class="form-group col-md-6">
                                {!! Form::label('Diplômes') !!}<span class="text-danger"> <b>*</b> </span>
                                {!! Form::select('diplomes[]', $diplomes, $demandeurs->diplomes, ['placeholder' => 'choisir', 'class' =>
