                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                {!! Form::select('departement', $departements, null, ['placeholder' => 'Choir un département', 'class' => 'form-control', 'id' => 'departement', 'data-width' => '100%']) !!}
                                <small id="emailHelp" class="form-text text-muted">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                ...
                                {!! Form::textarea('qualification', null, ['placeholder' => 'Qualifications et autres diplômes', 'rows' => 2, 'class' => 'form-control']) !!}
                            </div>
                            <div class="form-group col-md-6 col-lg-6 col-xs-12 col-sm-12">
