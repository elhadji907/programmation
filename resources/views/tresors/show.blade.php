        ...
        <div class="container">
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h1 class="card-title">{!! $tresor->courrier->types_courrier->name !!}</h1>
                        <h4 class="card-category">{!! $tresor->courrier->objet !!}</h4>
                        <p>{{ $tresor->courrier->message }}</p>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            ...
                            @endcan 
                            <a href="{!! url('courriers/' .$tresor->courrier->id. '/edit') !!}" title="voir les d&eacute;tails du courrier" class="btn btn-outline-primary">
