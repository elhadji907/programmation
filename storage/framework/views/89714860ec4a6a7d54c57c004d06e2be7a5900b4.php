...
<?php $__env->startSection('title', 'ONFP - Enregistrement des courriers reçus'); ?>
    ...
    <div class="container-fluid">
        ...
        <?php endif; ?>                    
            ...
            <div class="card">
                ...
                <div class="card-body">
                <?php echo Form::open(['url'=>'recues','files' => true]); ?>

                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <?php echo Form::label('Objet'); ?>                    
                            <?php echo Form::text('objet', null, ['placeholder'=>'Objet du courrier', 'class'=>'form-control', 'id'=>'objet']); ?>                    
                        </div> 
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <?php echo Form::date('date_cores', $date_r->format('Y-m-d'), ['placeholder'=>"La date de correspondance du courrier", 'class'=>'form-control']); ?>                    
                        </div>
                        <div class="form-group col-md-3">
                            <?php echo Form::label('Date réception', null, ['class' => 'control-label']); ?>                    
                            <?php echo Form::date('date_recep', $date_r->format('Y-m-d'), ['placeholder'=>"La date de reception du courrier", 'class'=>'form-control']); ?>                    
                        </div> 
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/recues/create.blade.php ENDPATH**/ ?>