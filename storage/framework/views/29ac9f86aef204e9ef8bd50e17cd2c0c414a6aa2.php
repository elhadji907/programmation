...
<?php $__env->startSection('content'); ?>
              ...
              <div class="card"> 
                ...
                <div class="card-body">
                      <div class="table-responsive">
                          <div align="right">
                            <a href="<?php echo e(route('personnels.create')); ?>"><div class="btn btn-success  btn-sm"><i class="fas fa-plus"></i>&nbsp;Ajouter</i></div></a>
                          </div>
                          <br />
      ...
      $(document).ready(function () {
          $('#table-personnels').DataTable( { 
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo e(route('personnels.list')); ?>",
            columns: [
                    { data: 'id', name: 'id' },
                ...
                "columnDefs": [
                        ...
                        url_e =  "<?php echo route('personnels.edit',':id'); ?>".replace(':id', data.id);
                        url_f =  "<?php echo route('personnels.show',':id'); ?>".replace(':id', data.id);
                        url_d =  "<?php echo route('personnels.destroy',':id'); ?>".replace(':id', data.id);
  ...
  <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/personnels/index.blade.php ENDPATH**/ ?>