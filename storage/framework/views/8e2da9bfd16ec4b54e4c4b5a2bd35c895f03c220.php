      ...
      <div class="col-md-12">              
        ...
        <div class="card">
            <div class="card-header">
                ...
                Liste des demandeurs en cours de formation au métier de <?php echo $nom_module.' | '.$localitesliste; ?>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered table-striped" id="moduleTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <?php if($demandeur->status == "En cours"): ?>                      
                  ...
                  <tr> 
                    ...
                    <td>
                        ...
                        <?php echo ucwords(strtolower($demandeur->localite->name)); ?>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/localites/lister_cours.blade.php ENDPATH**/ ?>