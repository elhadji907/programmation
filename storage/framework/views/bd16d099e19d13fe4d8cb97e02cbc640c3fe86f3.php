...
<?php $__env->startSection('title', 'ONFP - Liste des administrateurs'); ?>
<?php $__env->startSection('content'); ?>
              ...
              <div class="card"> 
                ...
                <div class="card-body">
                      <div class="table-responsive">
                          <div align="right">
                            <a href="<?php echo e(route('administrateurs.create')); ?>"><div class="btn btn-success  btn-sm"><i class="fas fa-plus"></i>&nbsp;Ajouter</i></div></a>
                          </div>
                          <br />
          ...
          $('#table-administrateurs').DataTable( { 
            ...
            columns: [
                ...
                "columnDefs": [
                        ...
                        url_e =  "<?php echo route('administrateurs.edit',':id'); ?>".replace(':id', data.id);
                        url_d =  "<?php echo route('administrateurs.destroy',':id'); ?>".replace(':id', data.id);
  ...
  <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/administrateurs/index.blade.php ENDPATH**/ ?>