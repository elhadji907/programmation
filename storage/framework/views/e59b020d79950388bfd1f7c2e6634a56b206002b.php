<?php $__env->startSection('title', 'ONFP - Fiche Couriers internes'); ?>
        ...
        <div class="container">
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3 class="card-title"><?php echo $interne->courrier->types_courrier->name; ?></h5>
                        <h5 class="card-category"><?php echo $interne->courrier->objet; ?></h5>
                        <p><?php echo e($interne->courrier->message); ?></p>

                        <div class="d-flex justify-content-between align-items-center">
                            <small>Posté le <?php echo Carbon\Carbon::parse($interne->courrier->created_at)->format('d/m/Y à H:i:s'); ?></small>
                            <span class="badge badge-primary"><?php echo $interne->courrier->user->firstname; ?>&nbsp;<?php echo $interne->courrier->user->name; ?></span>
                        </div>

                        <div class="d-flex justify-content-between align-items-center mt-5">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $interne->courrier)): ?>  
                            <a href="<?php echo url('internes/' .$interne->id. '/edit'); ?>" title="modifier" class="btn btn-outline-warning">
                                <i class="far fa-edit">&nbsp;Modifier</i>
                            </a>
                            <?php endif; ?> 
                            <a href="<?php echo url('courriers/' .$interne->courrier->id. '/edit'); ?>" title="voir les d&eacute;tails du courrier" class="btn btn-outline-primary">
                                <i class="far fa-eye">&nbsp;D&eacute;tails</i>
                            </a>
                            
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $interne->courrier)): ?>  
                            <?php echo Form::open(['method'=>'DELETE', 'url'=>'internes/' .$interne->id, 'id'=>'deleteForm', 'onsubmit' => 'return ConfirmDelete()']); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title text-center">Commentaires</h5>
                            <?php $__empty_1 = true; $__currentLoopData = $interne->courrier->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="card mt-2">
                                <div class="card-body">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>"  name="replayComment" rows="3" placeholder="Répondre à ce commentaire"></textarea>
                            ...
                            <?php endif; ?>
                            <form method="POST" action="<?php echo e(route('comments.store', $interne->courrier->id)); ?>" class="mt-3">
                                <?php echo csrf_field(); ?>                                                         
                                 <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/internes/show.blade.php ENDPATH**/ ?>