...
<?php $__env->startSection('title', 'ONFP - Liste des bénéficiaires'); ?>
<?php $__env->startSection('content'); ?>
              ...
              <div class="card"> 
                ...
                <div class="card-body">
                      <div class="table-responsive">
                          <div align="right">
                            <a href="<?php echo e(route('beneficiaires.create')); ?>"><div class="btn btn-success  btn-sm"><i class="fas fa-plus"></i>&nbsp;Ajouter</i></div></a>
                          </div>
                          <br />
      ...
      $(document).ready(function () {
          $('#table-beneficiaires').DataTable( { 
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo e(route('beneficiaires.list')); ?>",
            columns: [
                ...
                "columnDefs": [
                        ...
                        url_e =  "<?php echo route('beneficiaires.edit',':id'); ?>".replace(':id', data.id);
                        url_d =  "<?php echo route('beneficiaires.destroy',':id'); ?>".replace(':id', data.id);
  ...
  <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/beneficiaires/index.blade.php ENDPATH**/ ?>