<?php $__env->startSection('title', 'ONFP - Enregistrement facture '); ?>
                        ...
                        <form method="POST" action="<?php echo e(url('facturesdafs')); ?>">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    <?php echo Form::text('autres_montant', null, ['placeholder' => 'Le autres_montant en F CFA', 'class' => 'form-control']); ?>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/tresors/create.blade.php ENDPATH**/ ?>