...
<?php $__env->startSection('title', 'ONFP - Liste des options'); ?>
<?php $__env->startSection('content'); ?>
              ...
              <div class="card"> 
                ...
                <div class="card-body">
                      <div class="table-responsive">
                          <div align="right">
                            <a href="<?php echo e(route('options.create')); ?>"><div class="btn btn-success btn-sm"><i class="fas fa-plus"></i>&nbsp;Ajouter</i></div></a>
                          </div>
                          <br />
      ...
      $(document).ready(function () {
          $('#table-options').DataTable( { 
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo e(route('options.list')); ?>",
            columns: [
                    { data: 'id', name: 'id' },
                    { data: 'name', name: 'name' },
                ...
                "columnDefs": [
                        ...
                        url_e =  "<?php echo route('options.edit',':id'); ?>".replace(':id', data.id);
                        url_d =  "<?php echo route('options.destroy',':id'); ?>".replace(':id', data.id);
  ...
  <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/options/index.blade.php ENDPATH**/ ?>