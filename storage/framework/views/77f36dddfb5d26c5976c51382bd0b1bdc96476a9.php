            ...
            <div class="card">
                <?php $__currentLoopData = $banques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banque): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card-body">
                        ...
                        <h1 class="h4 card-title text-center h-100 text-uppercase mb-4"><b><?php echo ("Frais bancaire"); ?>

                                <?php echo ' '; ?> N° : </b><span
                                class="font-italic"><?php echo e($banque->courrier->numero ?? 'Aucun numéro'); ?></span></h1>
                        
                        <p><b><u class="h4">Designation</u> : </b><?php echo e($banque->designation ?? 'Aucune designation'); ?>

                        </p>
                        <p><b><u class="h4">Observation</u> : </b><?php echo e($banque->observation ?? 'Aucune observation'); ?>

                        </p>
                        <div class="d-flex justify-content-between align-items-center pt-2">
                            <p><b><u class="h4">Montant </u> : </b><span
                                    class="font-italic"><?php echo e($banque->courrier->total ?? 'Aucune montant'); ?></span><?php echo ' F CFA'; ?>

                            </p>
                            <span><b><u class="h4">Date mandat</u> : </b><?php echo Carbon\Carbon::parse($banque->date_mandat)->format('d/m/Y') ?? 'Pas encore mandaté'; ?></span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center pt-2">
                            <small>Posté le <?php echo Carbon\Carbon::parse($banque->courrier->created_at)->format('d/m/Y à H:i:s'); ?></small>
                            <span class="badge badge-primary"><?php echo $banque->courrier->user->firstname; ?>&nbsp;<?php echo $banque->courrier->user->name; ?></span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $banque->courrier)): ?>
                                <a href="<?php echo url('banques/' . $banque->id . '/edit'); ?>" title="modifier" class="btn btn-outline-warning">
                                    <i class="far fa-edit">&nbsp;Modifier</i>
                                </a>
                            <?php endif; ?>
                            <a href="<?php echo url('courriers/' . $banque->courrier->id . '/edit'); ?>" title="voir les d&eacute;tails du courrier"
                                class="btn btn-outline-primary">
                                <i class="far fa-eye">&nbsp;D&eacute;tails</i>
                            </a>
                            
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $banque->courrier)): ?>
            ...
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title text-center">Commentaires</h5>
                        <?php $__empty_1 = true; $__currentLoopData = $banque->courrier->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="card mt-2">
                                <div class="card-body">
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <?php endif; ?>
                        <form method="POST" action="<?php echo e(route('comments.store', $banque->courrier->id)); ?>" class="mt-3">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/banques/show.blade.php ENDPATH**/ ?>