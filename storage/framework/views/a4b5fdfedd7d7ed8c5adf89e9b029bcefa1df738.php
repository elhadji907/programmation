        ...
        <div class="card border-left-primary shadow h-100 py-2">
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">COURRIERS (TOTAL)</div>
      ...
      <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
          ...
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary"><?php echo e(("Pourcentage d'hommes et de femmes")); ?></h6>
      ...
      <div class="col-lg-6 mb-4">
        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            ...
            <a target="_blank" rel="nofollow" href="https://undraw.co/">Browse Illustrations  unDraw &rarr;</a>
          </div>
        </div>
...
</div><?php /**PATH /var/www/html/programmation/resources/views/layout/main.blade.php ENDPATH**/ ?>