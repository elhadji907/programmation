<?php $__env->startSection('title', 'ONFP - Enregistrement gestionnaires'); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header card-header-primary text-center">
                    ...
                    <p class="card-category">Gestionnaires</p>
                </div>
                <div class="card-body">
                                               
                        <form method="POST" action="<?php echo e(url('gestionnaires')); ?>">
                           <?php echo csrf_field(); ?>
                            <div class="form-row">
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/gestionnaires/create.blade.php ENDPATH**/ ?>