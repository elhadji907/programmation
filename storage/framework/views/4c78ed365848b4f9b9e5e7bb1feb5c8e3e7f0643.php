            ...
            $('#table-employees').DataTable({
                ...
                "columnDefs": [{
                        ...
                        "render": function(data, type, row) {
                            url_e =  "<?php echo route('directions.edit',':id'); ?>".replace(':id', data.id);
                            return '<a href=' + url_e +
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/directions/selectemployforup.blade.php ENDPATH**/ ?>