            ...
            <div class="container-fluid">
                ...
                <div class="card p-3">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['url' => 'tresors/' . $tresor->id, 'method' => 'PATCH', 'files' => true]); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::date('date_imp', Carbon\Carbon::parse($tresor->date_imp)->format('Y-m-d'), ['placeholder' => '', 'class' => 'form-control']); ?>
                            ...
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::date('date_recep', Carbon\Carbon::parse($tresor->date_recep)->format('Y-m-d'), ['placeholder' => '', 'class' => 'form-control']); ?>
                            ...
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::text('numero_courrier', $tresor->courrier->numero, ['placeholder' => 'numero du courrier', 'class' => 'form-control']); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::textarea('objet', $tresor->courrier->objet, ['placeholder' => 'objet', 'rows' => 2, 'class' => 'form-control']); ?>
                            ...
                            <div class="form-group col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::textarea('designation', $tresor->designation, ['placeholder' => 'designation', 'rows' => 2, 'class' => 'form-control']); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::text('montant', $tresor->montant, ['placeholder' => 'Le montant en F CFA', 'class' => 'form-control']); ?>
                            ...
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::text('autres_montant', $tresor->courrier->autres_montant, ['placeholder' => 'Autre montant', 'class' => 'form-control']); ?>
                            ...
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::text('numero_mandat', $tresor->numero, ['placeholder' => 'Le numéro du mandat', 'class' => 'form-control']); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::date('date_cg', Carbon\Carbon::parse($tresor->date_cg)->format('Y-m-d'), ['placeholder' => '', 'class' => 'form-control']); ?>
                            ...
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::date('date_dg', Carbon\Carbon::parse($tresor->date_dg)->format('Y-m-d'), ['placeholder' => '', 'class' => 'form-control']); ?>
                            ...
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::date('date_ac', Carbon\Carbon::parse($tresor->date_ac)->format('Y-m-d'), ['placeholder' => '', 'class' => 'form-control']); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::email('email', $tresor->courrier->email, ['placeholder' => 'adresse e-mail', 'class' => 'form-control', 'id' => 'email']); ?>
                            ...
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::text('telephone', $tresor->courrier->telephone, ['placeholder' => 'numero de téléphone', 'class' => 'form-control']); ?>
                            ...
                            <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::textarea('adresse', $tresor->courrier->adresse, ['placeholder' => 'adresse', 'rows' => 1, 'class' => 'form-control']); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                ...
                                <?php echo Form::textarea('observation', $tresor->observation, ['placeholder' => 'observations éventuelles', 'rows' => 2, 'class' => 'form-control']); ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <?php echo Form::text('legende', $tresor->courrier->legende, ['placeholder' => 'attribué un nom du fichier joint', 'data-width' => '100%', 'class' => 'form-control']); ?>
...
<?php $__env->startSection('javascripts'); ?>
    <script type="text/javascript">
        $('#direction').select2().val(<?php echo json_encode($tresor->courrier->directions()->allRelatedIds()); ?>).trigger('change');
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/tresors/update.blade.php ENDPATH**/ ?>