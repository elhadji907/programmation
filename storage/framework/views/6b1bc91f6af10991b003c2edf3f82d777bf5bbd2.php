...
<?php $__env->startSection('content'); ?>
              ...
              <div class="card"> 
                ...
                <div class="card-body">
                      <div class="table-responsive">
                          <div align="right">
                            <a href="<?php echo e(route('recues.create')); ?>"><div class="btn btn-success">Nouveau Utilisateur&nbsp;<i class="fas fa-user-plus"></i></div></a>
                          </div>
                          <br />
      ...
      $(document).ready(function () {
          $('#table-recues').DataTable( { 
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo e(route('recues.list')); ?>",
            columns: [
                    { data: 'id', name: 'id' },
                ...
                "columnDefs": [
                        ...
                        url_e =  "<?php echo route('recues.edit',':id'); ?>".replace(':id', data.id);
                        url_f =  "<?php echo route('recues.selectdirection',':id'); ?>".replace(':id', data.id);
                        url_d =  "<?php echo route('recues.destroy',':id'); ?>".replace(':id', data.id);
  ...
  <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/internes/selectdirection.blade.php ENDPATH**/ ?>