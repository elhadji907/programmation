...
<?php $__env->startSection('title', 'ONFP - Enregistrement programmes'); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(url('programmes')); ?>">
                           <?php echo csrf_field(); ?>
                            <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="input-name"><b><?php echo e(__("Nom du programme")); ?>:</b></label>
                                <input type="text" name="name" class="form-control" id="input-name" placeholder="Nom du programme" value="<?php echo e(old('name')); ?>">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="sigle" class="form-control" id="input-name" placeholder="sigle" value="<?php echo e(old('sigle')); ?>">
                                <small id="emailHelp" class="form-text text-muted">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="effectif" class="form-control" id="input-name" placeholder="effectif" value="<?php echo e(old('effectif')); ?>">
                                <small id="emailHelp" class="form-text text-muted">
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/programmes/create.blade.php ENDPATH**/ ?>