<?php $__env->startSection('title', 'ONFP - Liste des gestionnaires'); ?>
<?php $__env->startSection('content'); ?>
              ...
              <div class="card"> 
                ...
                <div class="card-body">
                      <div class="table-responsive">
                          <div align="right">
                            <a href="<?php echo e(route('gestionnaires.create')); ?>"><div class="btn btn-success  btn-sm"><i class="fas fa-plus"></i>&nbsp;Ajouter</i></div></a>
                          </div>
                          <br />
      ...
      $(document).ready(function () {
          $('#table-gestionnaires').DataTable( { 
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo e(route('gestionnaires.list')); ?>",
            columns: [
                    { data: 'id', name: 'id' }, 
                ...
                "columnDefs": [
                        ...
                        url_e =  "<?php echo route('gestionnaires.edit',':id'); ?>".replace(':id', data.id);
                        url_d =  "<?php echo route('gestionnaires.destroy',':id'); ?>".replace(':id', data.id);
  ...
  <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/gestionnaires/index.blade.php ENDPATH**/ ?>