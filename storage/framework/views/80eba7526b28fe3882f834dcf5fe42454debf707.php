...
<?php $__env->startSection('title', 'ONFP - Enregistrement domaines'); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header card-header-primary text-center">
                    ...
                    <p class="card-category"><?php echo e(("Secteur d'activité")); ?></p>
                </div>
                <div class="card-body">                                               
                        <form method="POST" action="<?php echo e(url('domaines')); ?>">
                           <?php echo csrf_field(); ?>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="name" class="form-control" id="input-name" placeholder="ex: industrie" value="<?php echo e(old('name')); ?>">
                                    <small id="emailHelp" class="form-text text-muted">
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/domaines/create.blade.php ENDPATH**/ ?>