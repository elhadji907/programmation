...
<?php $__env->startSection('title', 'ONFP - Modification domaines'); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header card-header-primary text-center">
                    ...
                    <p class="card-category"><?php echo e(("Domaine")); ?></p>
                </div>
                <div class="card-body">
                                               
                        <form method="POST" action="<?php echo e(action('DomainesController@update', $id)); ?>">
                           <?php echo csrf_field(); ?>
                           <input type="hidden" name="_method" value="PATCH" /> 
                            <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="input-name"><b><?php echo e(__("Nom du domaine")); ?>:</b></label>
                                <input type="text" name="name" class="form-control" id="input-name" placeholder="ex: primaire" value="<?php echo e(old('name') ?? $domaines->name); ?>">
                            ...
                            <div class="form-group col-md-12">
                                <label for="input-name"><b><?php echo e(__("Secteur d'activité")); ?>:</b></label>
                                <select name="secteur" id="secteur" class="form-control">
                                    ...
                                    <small id="emailHelp" class="form-text text-muted">
                                        ...
                                        <?php $__currentLoopData = $errors->get('secteur'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <p class="text-danger"><?php echo e($message); ?></p>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </small>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/domaines/update.blade.php ENDPATH**/ ?>