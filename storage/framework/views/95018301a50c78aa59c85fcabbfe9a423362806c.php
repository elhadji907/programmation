<?php $__env->startSection('title', 'ONFP - Enregistrement projets'); ?>
        ...
        <div class="container col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(url('projets')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-row">
                                <div class="form-group col-md-8 col-lg-8 col-xs-12 col-sm-12">
                                    ...
                                    <input type="text" name="name" class="form-control" id="input-name"
                                        placeholder="nom complète" value="<?php echo e(old('name')); ?>">
                                ...
                                <div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    <input type="text" name="sigle" class="form-control" id="input-sigle"
                                        placeholder="nom complète" value="<?php echo e(old('sigle')); ?>">
                                    <small id="emailHelp" class="form-text text-muted">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                    ...
                                    <?php echo Form::date('debut', null, ['placeholder' => 'La date de démarrage', 'class' => 'form-control']); ?>
                                ...
                                <div class="form-group col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                    ...
                                    <?php echo Form::date('fin', null, ['placeholder' => 'La date de cloture', 'class' => 'form-control']); ?>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                    ...
                                    <input type="text" name="budjet" class="form-control" id="input-budjet"
                                        placeholder="Bdjet" value="<?php echo e(old('budjet')); ?>">
                                    <small id="emailHelp" class="form-text text-muted">
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/projets/create.blade.php ENDPATH**/ ?>