        ...
        <div class="container-fluid">
            <div class="card">
                <?php $__currentLoopData = $facturesdafs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facturesdaf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card-body">
                        <h1 class="h4 card-title text-center h-100 text-uppercase mb-4"><b><?php echo $facturesdaf->courrier->types_courrier->name; ?>

                                <?php echo ' '; ?> N° : </b><span
                                class="font-italic"><?php echo e($facturesdaf->numero ?? 'Aucun numéro'); ?></span></h1>
                        
                        <p><b><u class="h4">Designation</u> : </b><?php echo e($facturesdaf->courrier->designation ?? 'Aucune designation'); ?>

                        </p>
                        <p><b><u class="h4">Observation</u> : </b><?php echo e($facturesdaf->courrier->observation ?? 'Aucune observation'); ?>

                        </p>
                        <div class="d-flex justify-content-between align-items-center pt-2">
                            <p><b><u class="h4">Montant </u> : </b><span
                                    class="font-italic"><?php echo e($facturesdaf->courrier->total ?? 'Aucune montant'); ?></span><?php echo ' F CFA'; ?>

                            </p>
                            <span><b><u class="h4">Date mandat</u> : </b><?php echo Carbon\Carbon::parse($facturesdaf->date_mandat)->format('d/m/Y') ?? 'Pas encore mandaté'; ?></span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center pt-2">
                            <small>Posté le <?php echo Carbon\Carbon::parse($facturesdaf->courrier->created_at)->format('d/m/Y à H:i:s'); ?></small>
                            <span class="badge badge-primary"><?php echo $facturesdaf->courrier->user->firstname; ?>&nbsp;<?php echo $facturesdaf->courrier->user->name; ?></span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            
                                <a href="<?php echo url('facturesdafs/' . $facturesdaf->id . '/edit'); ?>" title="modifier" class="btn btn-outline-warning">
                                    <i class="far fa-edit">&nbsp;Modifier</i>
                                </a>
                            
                            <a href="<?php echo url('courriers/' . $facturesdaf->courrier->id . '/edit'); ?>" title="voir les d&eacute;tails du courrier"
            ...
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title text-center">Commentaires</h5>
                        <?php $__empty_1 = true; $__currentLoopData = $facturesdaf->courrier->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="card mt-2">
                                <div class="card-body">
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <?php endif; ?>
                        <form method="POST" action="<?php echo e(route('comments.store', $facturesdaf->courrier->id)); ?>" class="mt-3">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/facturesdafs/show.blade.php ENDPATH**/ ?>