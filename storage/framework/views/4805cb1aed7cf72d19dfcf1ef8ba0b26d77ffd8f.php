      ...
      <div class="col-md-12">              
        ...
        <div class="card">
            <div class="card-header">
                ...
                Liste des demandeurs non retenus au métier de <?php echo $nom_module.' | '.$localitesliste; ?>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered table-striped" id="moduleTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <?php if($demandeur->status == "Annulée"): ?>                      
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/programmation/resources/views/localites/lister_an.blade.php ENDPATH**/ ?>